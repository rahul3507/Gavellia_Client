          ...
          <div className="space-y-4 md:space-y-6 ">
            ...
            <div className="space-y-3 ">
              ...
              <p className="text-primary/50 text-xs md:text-sm leading-relaxed">
                ...
                hardware, including heavy-duty zippers and snaps, with the
                distinctive quilted lining intact. Measuring a true size 42
                (fitting chest sizes 40-44), it displays only minor wear - just
                a small scuff on the left sleeve that adds character. Currently
                at £{productData.highestBid} with {productData.bids} bids
                placed, this auction ends in just {productData.time} from the
                starting bid of £{productData.starting}. Originally worn fewer
                than 10 times and carefully stored in climate-controlled
                conditions, this collector-quality piece comes with authenticity
                verification. Perfect for vintage fashion enthusiasts or
                motorcycle collectors seeking genuine 1980s style, this jacket
                offers worldwide shipping at £15 within the UK or £35
                internationally. Don&apos;t miss this rare opportunity to own a
                perfectly preserved piece of biker heritage.
              </p>
            </div>
